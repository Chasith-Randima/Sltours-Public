...
exports.protect = catchAsync(async (req,res,next) => {
    ...
    if(currentUser.changedPasswordAfter(decoded.iat)){
        return next(new AppError("User recently changed password again!please log in",401))
    };
...
exports.forgotPassword = catchAsync(async(req,res,next) => {
    ...
    return next(new AppError("there was an error sendin email please try again later"),500);
}
